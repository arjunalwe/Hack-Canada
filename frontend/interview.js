/* ──────────────────────────────────────────────────────
   ...
   Phases: Setup → Live Interview → Feedback
────────────────────────────────────────────────────── */
...
async function playQuestionAudio() {
    ...
    interviewStatus.textContent = 'Your turn — click the mic to respond';
    micArea.hidden = false;
    micHint.textContent = 'Click to respond';
}
...
async function startRecording() {
    ...
    micHint.textContent = 'Listening… click again to stop';
    ...
    if (SpeechRecognition) {
        ...
        micHint.textContent = '⚠ Speech Recognition not supported — type your response below';
...
function stopRecording() {
    ...
    // If editable fallback was used, grab the text
    if (liveText.contentEditable === 'true') {
        userResponseText = liveText.textContent.trim();
    }

    if (userResponseText.trim()) {
        micHint.textContent = 'Response captured';
...
/* ═══════════════════════════════════════════════════════
   SEND RESPONSE
═══════════════════════════════════════════════════════ */
sendBtn.addEventListener('click', submitResponse);
